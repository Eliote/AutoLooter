...
local function CreateLeftWidgets()
	...
	ignoreBop:SetCallback("OnValueChanged", function(self, event, checked) PRIVATE_TABLE.DB.ignoreBop = AUTO_LOOTER.GetBoolean(checked) end)
